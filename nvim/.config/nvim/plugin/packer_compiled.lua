...
_G.packer_plugins = {
  ...
  ["git-blame.nvim"] = {
    loaded = true,
    path = "/home/thomas/.local/share/nvim/site/pack/packer/start/git-blame.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/home/thomas/.local/share/nvim/site/pack/packer/start/typescript.nvim",
...
try_loadstring("\27LJ\2\n1\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\22config.catppuccin\frequire\0", "config", "catppuccin")
